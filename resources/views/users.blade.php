...
<script type="text/javascript">
    ...
    function update()
    {
        ...
        success: function(data)
        {
             ...
             error: function (jqXHR, textStatus, errorThrown)
             {
              alert('Error adding / update data. Try inserting your password and try again');
            }
          });   
    }
    function save()
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                <label class="col-form-label">Password</label>
                  <input style="font-size: 13px" id="txtPassword" name="txtPassword" placeholder="Password" class="form-control" type="password" required="required">
              </div>           
              <div class="form-group">
                <label class="col-form-label">Password Confirm</label>
                  <input style="font-size: 13px" id="txtConfirm" name="txtConfirm" placeholder="Password Confirm" class="form-control" type="password" required>
              </div>   
              <div class="form-group">
